// ============================================================
// PocketDay — SubscriptionsContent
// ============================================================
//
// Purpose:
// Reusable presentation widget rendering the complete recurring subscriptions content interface.
// Designed to be embedded cleanly inside BudgetScreen Tab 1 or wrapped inside SubscriptionsScreen Scaffold.
//
// Responsibilities:
// - Render top hero card displaying total normalized monthly recurring spend.
// - Render inline search input bar and sort popup menu.
// - Render status filter chips (All, Active, Paused, Cancelled).
// - Render horizontal upcoming payments carousel for subscriptions due soon.
// - Render grid/list of SubscriptionCard items using Riverpod subscriptionProvider state.
// - Handle pull-to-refresh data reloading via RefreshIndicator.
//
// Data Flow:
// Cloud Firestore → SubscriptionRepository → subscriptionProvider → SubscriptionsContent UI → SubscriptionCard / AddSubscriptionSheet
//
// Important Rules:
// - Does not contain a top-level Scaffold, AppBar, or FloatingActionButton; relies on host layout shell or BudgetScreen.
// - Search query and sort option update subscriptionProvider state reactively.
//
// Main Operations:
// - build(context, ref) — Watches subscriptionProvider state and renders search, metrics, filters, and subscription cards.
// - _openAddSheet(context, [sub]) — Displays modal bottom sheet for creating or editing subscriptions.
// - _confirmDelete(context, sub) — Displays deletion confirmation dialog.
//
// Dependencies / Collaborators:
// - subscriptionProvider — Riverpod state notifier owning subscription list, search query, status filters, and deletion operations.
// - SubscriptionCard — ListItem widget displaying single recurring subscription item.
// - AddSubscriptionSheet — Modal bottom sheet for instantiating or editing subscriptions.
//
// ============================================================
...
/// Reusable subscription feed content (without Scaffold or FAB).
